from typing import Any, Dict, List, Protocol, Tuple, TypeVar, runtime_checkable

from core.interfaces.base_item_action import IMTActionData, MTDevice, MTKeyState
