'''authorship : Jie Jenn https://youtu.be/LW__NuulfxE'''
'''modify : aoiupen '''
import csv
import sys
...
class MyWindow(QMainWindow):
    def __init__(self):
        ...
        gr_A = TreeWidgetItem(self.tw)
        gr_A.setText(0,"GroupA")
        
        s_img1 = TreeWidgetItem(gr_A)
        s_img1.setText(0,"SaveImg")
        s_img1.setText(1,"Mouse")
        s_img1.setText(2,"Click")
        s_img1.setText(3,"259,12")
        
        s_img2 = TreeWidgetItem(gr_A)
        s_img2.setText(0,"FileName")
        s_img2.setText(1,"Mouse")
        s_img2.setText(2,"Click")
        s_img2.setText(3,"318,15")
        
        s_img3 = TreeWidgetItem(gr_A)
        s_img3.setText(0,"Content")
        s_img3.setText(1,"Key")
        s_img3.setText(2,"Typing")
        s_img3.setText(4,"C:\\abc\\abcd")

        gr_B = TreeWidgetItem(self.tw)
        gr_B.setText(0,"GroupB")
        gr_B.setExpanded(True)
    
        b_img0 = TreeWidgetItem(gr_B)
        b_img0.setText(0,"gr_b1")
    
        b_img1_01 = TreeWidgetItem(b_img0)
        b_img1_01.setText(0,"SaveImg")
        b_img1_01.setText(1,"Mouse")
        b_img1_01.setText(2,"Click")
        b_img1_01.setText(3,"259,12")
    
        b_img1 = TreeWidgetItem(gr_B)
        b_img1.setText(0,"gr_b2")

        b_img1_c = TreeWidgetItem(b_img1)
        b_img1_c.setText(0,"SaveImg")
        b_img1_c.setText(1,"Mouse")
        b_img1_c.setText(2,"Click")
        b_img1_c.setText(3,"259,12")
        
        b_img1_d = TreeWidgetItem(b_img1)
        b_img1_d.setText(0,"SaveImg")
        b_img1_d.setText(1,"Mouse")
        b_img1_d.setText(2,"Click")
        b_img1_d.setText(3,"259,12")

        gr_C = TreeWidgetItem(self.tw)
        gr_C.setText(0,"GroupC")
    ...
    def recur_child(self,writer,parent):
        if parent.childCount():
            ...
            #lst = [parent.text(i) for i in range(self.tw.columnCount())]
            #lst.insert(0,parent.prnt.text(0))            
            #writer.writerow(lst)
            return
        return
